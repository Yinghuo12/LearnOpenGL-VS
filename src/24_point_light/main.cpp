...
int main(int argc, char *argv[]) {
  ...
  // shader
  Shader ourShader("../src/24_point_light/shader/vertex.glsl", "../src/24_point_light/shader/fragment.glsl");
  Shader lightObjectShader("../src/24_point_light/shader/light_object_vert.glsl", "../src/24_point_light/shader/light_object_frag.glsl");
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    glm::vec3 lightPos = glm::vec3(lightPosition.x * glm::sin(glfwGetTime()) * 2.0, lightPosition.y, lightPosition.z);  // 让光源移动

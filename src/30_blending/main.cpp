...
int main(int argc, char *argv[]) {
  ...
  Shader sceneShader("../src/30_blending/shader/scene_vert.glsl", "../src/30_blending/shader/scene_frag.glsl");
  Shader lightObjectShader("../src/30_blending/shader/light_object_vert.glsl", "../src/30_blending/shader/light_object_frag.glsl");
  ...
  while (!glfwWindowShouldClose(window)){
    ...
    glm::vec3 lightPos = glm::vec3(lightPosition.x * glm::sin(glfwGetTime()) * 2.0, lightPosition.y, lightPosition.z);    // 移动平行光源
    sceneShader.use();

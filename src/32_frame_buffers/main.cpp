...
int main(int argc, char *argv[]) {
  ...
  Shader sceneShader("../src/32_frame_buffers/shader/scene_vert.glsl", "../src/32_frame_buffers/shader/scene_frag.glsl");
  Shader frameBufferShader("../src/32_frame_buffers//shader/frame_buffer_quad_vert.glsl", "../src/32_frame_buffers/shader/frame_buffer_quad_frag.glsl");
  Shader lightObjectShader("../src/32_frame_buffers/shader/light_object_vert.glsl", "../src/32_frame_buffers/shader/light_object_frag.glsl");
  ...
  glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, SCREEN_WIDTH, SCREEN_HEIGHT, 0, GL_RGB, GL_UNSIGNED_BYTE, NULL);  // 给纹理的data参数传递NULL,仅仅分配内存而没有填充他

...
int main() {
  ...
  // shader
  Shader ourShader("../src/18_light_scene/shader/vertex.glsl", "../src/18_light_scene/shader/fragment.glsl");
  Shader lightObjectShader("../src/18_light_scene/shader/light_object_vert.glsl", "../src/18_light_scene/shader/light_object_frag.glsl");
  ...
  ourShader.setVec3("lightColor", glm::vec3(0.0f, 1.0f, 0.0f));  //光照颜色
